...
import type { LeadershipMember } from '../../types/AdminTypes';
...
export function LeadershipManager() {
  ...
  const handleMove = (index: number, direction: 'up' | 'down') => {
    ...
    mockAdminService.saveLeadershipMember(newMembers[index]);
    mockAdminService.saveLeadershipMember(newMembers[targetIndex]);
    loadMembers();
  };
    ...
    <div className="leadership-manager">
      ...
      <div className="admin-table-container">
        <table className="admin-table">
          ...
          <tbody>
            {members.sort((a,b) => a.order - b.order).map((m, index) => (
              <tr key={m.id}>
                <td>
                ...
                <td className="admin-table__actions">
                  ...
                  <button onClick={() => handleDelete(m.id)} className="btn-delete"><Trash2 size={16} /></button>
                </td>
              </tr>
            ))}
          </tbody>
