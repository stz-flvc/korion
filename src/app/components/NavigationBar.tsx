...
export const NavigationBar = memo(function NavigationBar() {
  ...
  const navGroups: NavGroup[] = [
      ...
      items: [
        {
          label: 'GitHub',
          labelKo: '깃허브',
          path: 'https://github.com/KORION-Official/korion-contract',
    ...
    },
    {
      ...
      items: [
        {
          label: 'Sun.io Listing',
          labelKo: 'SUN.io 거래',
          path: 'https://sun.io/?lang=en-US#/scan/pairDetail?pairAddress=TCHbWJUBZ9DVpaPb6QW9vb31yTSz7sfhQh&version=v2',
          desc: 'Trade KORION on SunSwap',
          descKo: 'SunSwap에서 KORI 거래',
        ...
        <div className="korion-nav__inner">
          <div className="korion-nav__left">
            ...
            <div className="korion-nav__desktop-menu">
              <Link
                to="/"
                className={`korion-nav__link ${location.pathname === '/' ? 'is-active' : ''}`}
              >
                <span>{t('Home', '홈')}</span>
              </Link>
          ...
          <div className="korion-nav__actions">
            ...
            <Link to="/admin/login" className="korion-nav__link standalone-admin-link">
              <ShieldCheck size={16} />
              <span>Admin</span>
            </Link>
              ...
              <div className="korion-nav__mobile-menu-inner">
                <div className="korion-nav__mobile-group">
                  <Link
                    ...
                    className={`korion-nav__mobile-item korion-nav__mobile-item--single ${location.pathname === '/' ? 'is-active' : ''}`}
                  >
